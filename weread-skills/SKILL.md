...
该 Skill 使用宿主机 `weread-skills` 能力。API Key 从 `~/.agentdock/skill-data/weread-skills/.env` 或当前命令环境读取，不包含在 Skill 包中。
...
SKILL_DIR="$AGENTDOCK_HOME/skill-store/installed/weread-skills/1.0.5"
ENV_FILE="$AGENTDOCK_HOME/skill-data/weread-skills/.env"
```
